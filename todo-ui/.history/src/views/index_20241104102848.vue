<template>
  ...
  <!-- 模块排版 -->
  <!-- 下侧大模块 -->
  <el-row class="tac1" style="height: 700px; background-color: lightblue;">
    <el-col :span="12"> <!--左下大块部分，显示销售，库存，患者等数据信息 -->
      <div
        style="width: 100%; height: 500px; margin: 0 auto; flex-wrap: wrap; justify-content: center; align-items: center; background-color: lightblue;">
