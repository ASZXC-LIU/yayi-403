<template>
  <el-row class="tac1" style="height: 300px; background-color: red;">
    <el-col :span="12">
      <div style="max-width: 1200px; width: 100%;height: 300px; margin: 0 auto; flex-wrap: wrap; justify-content: space-between; align-items: center; background-color: gray;">
        <el-card style="width: 99%; height: 297px; position: relative; overflow: hidden; border: 1px solid gray; margin: auto;">
  ...
  <el-row class="tac1" style="height: 590px; background-color: lightblue;">
    <el-col :span="12">
      <div style="width: 100%; height: 590px; margin: 0 auto; flex-wrap: wrap; justify-content: center; align-items: center; background-color: lightblue;">
        <el-card style="width: 99%; height: 570px; position: relative; overflow: hidden; border: 1px solid gray; margin: auto;">
          <div>收银记录</div>
          <el-divider />
          <el-row style="width: 100%;">
            <el-col :span="12" style="padding: 0;">
              <el-card class="box-card" shadow="hover" style="height: 124px; border: none;">
                ...
                <div class="card-content"><span>124</span></div>
              </el-card>
            </el-col>
            <el-col :span="12" style="padding: 0;">
              <el-card class="box-card" shadow="hover" style="height: 124px; border: none;">
                <div slot="header" class="clearfix"><span>总金额(元)</span></div>
                <div class="card-content"><span>{{ filteredAmountSum }}</span></div>
              </el-card>
            </el-col>
            <el-col :span="12" style="padding: 0;">
              <el-card class="box-card" shadow="hover" style="height: 124px; border: none;">
            ...
            <el-col :span="12" style="padding: 0;">
              <el-card class="box-card" shadow="hover" style="height: 124px; border: none;">
                ...
                <div class="card-content"><span>4</span></div>
              </el-card>
            </el-col>
          </el-row>
        </el-card>
  ...
  const handleDateChange = (date) => {
    selectedDate.value = dayjs(date).format('YYYY-MM-DD'); // 更新选中的日期并格式化
  };
