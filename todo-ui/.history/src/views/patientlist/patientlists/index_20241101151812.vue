<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item class="serchRecordNumber" label="患者病历号" prop="medicalRecordNumber" style="width: 250px;">
        <el-input
      ...
      <el-form-item label="患者联系电话" prop="phone" style="width: 250px;">
        <el-input
    ...
    <el-table v-loading="loading" :data="patientlistsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="患者病历号" align="center" prop="medicalRecordNumber" style="width: 95px;"/>
      ...
      <el-table-column label="患者联系电话" align="center" prop="phone" />
