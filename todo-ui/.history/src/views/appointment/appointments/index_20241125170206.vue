...
function updateDateRange(value) {
  ...
  const startOfToday = new Date(today.getFullYear(), today.getMonth(), today.getDate()+1);
  ...
  if (value === "today") {
    ...
    //   1: formatDate(new Date(startOfToday.getTime() + 24 * 60 * 60 * 1000 - 1)), // 当天的最后一秒

    // };
    console.log("this.queryParams.value:",queryParams.value)
    console.log("data.value:",data)
    console.log("data.queryParams.value:",data.queryParams)
    data.queryParams.value.beginTime = formatDate(startOfToday);
    data.queryParams.value.endTime = formatDate(new Date(startOfToday.getTime() + 24 * 60 * 60 * 1000 - 1));
    console.log("this.queryParams.value:",queryParams.value)
    dateRange.value.push(formatDate(startOfToday));
    dateRange.value.push(formatDate(new Date(startOfToday.getTime() + 24 * 60 * 60 * 1000 - 1)));
  } else if (value === "tomorrow") {
    const startOfTomorrow = new Date(startOfToday.getTime() + 24 * 60 * 60 * 1000);
    // dateRange.value = {
    //   0: formatDate(startOfTomorrow),
    //   1: formatDate(new Date(startOfTomorrow.getTime() + 24 * 60 * 60 * 1000 - 1)), // 明天的最后一秒
    // };
    ...
    const endOfWeek = new Date(startOfWeek.getTime() + 6 * 24 * 60 * 60 * 1000 + 24 * 60 * 60 * 1000 - 1); // 本周日结束
    // dateRange.value = {
