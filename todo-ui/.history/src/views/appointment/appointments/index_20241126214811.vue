<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
    <el-button type="success" plain icon="Money" @click="handleBill">结账</el-button>
  </el-col>
    ...
    <!-- 结账表单对话框 -->
<el-dialog :title="'结账'" v-model="billDialogVisible" width="500px" append-to-body>
  <el-form ref="billFormRef" :model="billForm" :rules="billRules" label-width="80px">
    <el-form-item label="患者姓名" prop="patientName">
      <el-input v-model="billForm.patientName" placeholder="请输入患者姓名" />
    </el-form-item>
    <el-form-item label="医生姓名" prop="doctorName">
      <el-input v-model="billForm.doctorName" placeholder="请输入医生姓名" />
    </el-form-item>
    <el-form-item label="账单金额" prop="amount">
      <el-input v-model="billForm.amount" type="number" placeholder="请输入账单金额" />
    </el-form-item>
    <el-form-item label="支付状态" prop="paymentStatus">
      <el-select v-model="billForm.paymentStatus" placeholder="请选择支付状态">
        <el-option label="已支付" value="paid" />
        <el-option label="未支付" value="unpaid" />
      </el-select>
    </el-form-item>
    <el-form-item label="支付方式" prop="paymentMethod">
      <el-select v-model="billForm.paymentMethod" placeholder="请选择支付方式">
