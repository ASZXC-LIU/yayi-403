<template>
  ...
  <!-- 模块排版 -->
  <!-- 下侧大模块 -->
  <el-row class="tac1" style="height: 600px; background-color: lightblue;">
    <el-col :span="12"> <!--左下大块部分，显示销售，库存，患者等数据信息 -->
      <div
        style="width: 100%; height: 600px; margin: 0 auto; flex-wrap: wrap; justify-content: center; align-items: center; background-color: lightblue;">

        <el-card
          style="width: 99%; height: 500px; position: relative; overflow: hidden; border: 1px solid gray; margin: auto;">
          <div style="margin: 0 ">
            今日到访
          </div>
          <el-divider /> <!-- 上下分割线 -->
