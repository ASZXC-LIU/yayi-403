<template>
  ...
  <el-col :span="12" style="padding: 0;">
    <el-card class="box-card" shadow="hover" style="height: 124px; border: none; display: flex; flex-direction: column; justify-content: center;">
      <div slot="header" class="clearfix">
        <span>今日单数(人)</span>
      </div>
      <div class="card-content" style="flex: 1; display: flex; justify-content: center; align-items: center;">
        <span>124</span>
      </div>
    </el-card>
  </el-col>
