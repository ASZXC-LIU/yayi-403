<template>
  ...
  <!-- 模块排版 -->
  <!-- 大模块 -->
  <el-row class="tac1" style="height: 300px; background-color: blue;">
    <el-col :span="24">
      <div
        style="max-width: 1200px; width: 100%; height: 300px; margin: 0 auto; flex-wrap: wrap; justify-content: center; align-items: center; background-color: lightblue;">
        <!-- 大模块内容 -->
        <el-card
