  ...
  <el-row class="tac1" style="height: 300px; background-color: red;">
    ...
    <el-col :span="12">
      <div
        ...
        <!-- 卡片 -->
        <el-card
          style="width: 99%; height: 297px;  position: relative; overflow: hidden;border: 1px solid gray;margin:  auto;display: flex;">
          <div style="margin: 0 20px 0 20px; ">
            今日到访
          </div>
          <el-divider />
          <div style="display: flex; justify-content: space-between;margin:auto 0;">
            <!-- 卡片中三个数据 -->
