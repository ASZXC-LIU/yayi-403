<template>
  ...
  <el-row style="position: relative; height: 100%;">
    <!-- 垂直分割线 -->
    <div style="position: absolute; top: 50%; left: 0; right: 0; height: 1px; background-color: gray; transform: translateY(-50%);"></div>
    <!-- 水平分割线 -->
    <div style="position: absolute; top: 0; bottom: 0; left: 50%; width: 1px; background-color: gray; transform: translateX(-50%);"></div>
