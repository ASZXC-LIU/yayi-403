  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="更新时间" prop="beginTime">
        <el-date-picker clearable v-model="queryParams.beginTime" type="datetime" value-format="YYYY-MM-DD HH:mm:ss" placeholder="开始日期时间">
        </el-date-picker>
        -
        <el-date-picker clearable v-model="queryParams.endTime" type="datetime" value-format="YYYY-MM-DD HH:mm:ss"  placeholder="结束日期时间">
        </el-date-picker>
      </el-form-item>
