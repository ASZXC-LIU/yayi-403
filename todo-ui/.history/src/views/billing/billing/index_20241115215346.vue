    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="billingRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="账单日期" prop="billingDate">
          <el-date-picker clearable v-model="form.billingDate" type="date" value-format="YYYY-MM-DD "
            placeholder="请选择账单日期">
          </el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="支付状态" prop="paymentStatus">
          <el-radio-group v-model="form.paymentStatus">
            <el-radio v-for="dict in tt_paystatus" :key="dict.value" :label="dict.value">
              {{ dict.label }}
            </el-radio>
          </el-radio-group>
        </el-form-item>
