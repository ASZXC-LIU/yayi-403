<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <p>账单总数: {{ billingStatsStore.todayBillingCount }}</p>
    <p>总金额: {{ billingStatsStore.todayTotalAmount }}</p>
    <p>已支付金额: {{ billingStatsStore.todayPaidAmount }}</p>
    <p>未支付金额: {{ billingStatsStore.todayUnpaidAmount }}</p>
    </el-form>
