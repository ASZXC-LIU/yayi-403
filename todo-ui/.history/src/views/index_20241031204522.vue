<template>
  <!-- 第一行排版 -->
  <el-row class="tac1" style="height: 150px; background-color: red; display: flex;" >
    <!-- 第一列 -->
    <el-col :span="12">
      <div
  ...
  <el-row class="tac1" style="height: 1000px; background-color: lightblue;">
    <el-col :span="12"> <!--左下大块部分，显示销售，库存，患者等数据信息 -->
      <div
        style="max-width: 1200px; height: 1000px; margin: 0 auto; display: flex; justify-content: center; align-items: center; background-color: lightblue;">
        <div class="grid-container">
          <!-- 左上 -->
          <el-card class="grid-item top-left">
            <div style="margin: 0 20px 0 20px;">
              今日到访
            </div>
            <el-divider />
            <el-row>
              <el-col :span="12">
                <el-card class="box-card" shadow="hover" style="height: 124px;">
          ...
          <!-- 右上 -->
          <el-card class="grid-item top-right">
          ...
          <!-- 左下 -->
          <el-card class="grid-item bottom-left">
            <div style="margin: 20px;">
              <h2>大模块标题</h2>
              <p>这里是大模块的内容，可以显示详细的数据或图表。</p>
              <!-- 示例数据 -->
          ...
          <!-- 右下 -->
          <el-card class="grid-item bottom-right">
            <div style="margin: 20px;">
              <h2>大模块标题</h2>
              <p>这里是大模块的内容，可以显示详细的数据或图表。</p>
              <!-- 示例数据 -->
