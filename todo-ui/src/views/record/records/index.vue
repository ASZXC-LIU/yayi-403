<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['record:records:add']">新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['record:records:export']">导出
        </el-button>
      </el-col>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="recordsRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="就诊方式" prop="treatmentType">
          <el-input v-model="form.treatmentType" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        ...
        <el-form-item label="就诊状态" prop="medicalRecordsStatue">
          <el-select v-model="form.medicalRecordsStatue" placeholder="请选择预约状态">
            <el-option v-for="dict in statueOptions" :key="dict.id" :label="dict.value" :value="dict.value">
            </el-option>
          </el-select>
        </el-form-item>
