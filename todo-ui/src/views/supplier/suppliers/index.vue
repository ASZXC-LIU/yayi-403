  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['supplier:suppliers:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['supplier:suppliers:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="suppliersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['supplier:suppliers:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['supplier:suppliers:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="suppliersRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="供应商名称" prop="supplierName">
        ...
        <el-form-item label="备用电话" prop="supplierPhone2">
          <el-input v-model="form.supplierPhone2" placeholder="请输入备用电话" />
        </el-form-item>
        ...
        <el-form-item label="邮政编码" prop="supplierPost">
          <el-input v-model="form.supplierPost" placeholder="请输入邮政编码" />
        </el-form-item>
  ...
  proxy.$refs["suppliersRef"].validate(valid => {
    if (valid) {
      if (form.value.supplierId != null) {
        updateSuppliers(form.value).then(response => {
          proxy.$modal.msgSuccess("修改成功");
          open.value = false;
          getList();
        });
      } else {
        addSuppliers(form.value).then(response => {
