  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="medicineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['medicine:medicine:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['medicine:medicine:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除药品库存编号为"' + _medicineIds + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('medicine/medicine/export', {
    ...queryParams.value
